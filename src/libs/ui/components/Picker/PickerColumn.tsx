...
export const PickerColumn = forwardRef<HTMLSelectElement, PickerColumnProps>(
    ({ options, value, ...props }, ref) => {
        ...
        const optionRefs = useRef<
            Record<(typeof options)[number]["value"], HTMLDivElement>
        >({});
        ...
        useEffect(() => {
            ...
            containerRef.current!.scrollTop =
                optionRefs.current[option.value].offsetTop - 96;
        }, [options, value]);
        ...
        const change = useCallback(
            (option: PickerColumnOption) => {
                ...
                containerRef.current!.scrollTop =
                    options.findIndex((o) => o.value === option.value) * 32;
            },
            [domRef, options]
        );
        ...
        const changeByPosition = useCallback(() => {
