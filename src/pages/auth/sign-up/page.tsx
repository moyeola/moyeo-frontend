            ...
            <PageLayout>
                ...
                <Container gap={70}>
                    ...
                    <Text>
                        ...
                        &quot;모여! 서비스&quot; 이용 약관 제1장 총칙 제1조(목적) 이 약관은 모여!
                        서비스(이하 15M)가 제공하는 서비스의 이용과 관련하여 회사와 이용자와의 권리,
                        의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다. 제2조(약관의
                        효력 및 변경) 이 약관은 회사가 서비스 화면에 게시하거나 기타의 방법으로
                        이용자에게 공지함으로써 효력을 발생합니다. 회사는 필요한 경우 약관을 변경할
                        수 있으며, 변경된 약관은 전항과 같은 방법으로 공지하거나 통지함으로써 효력을
